...
#         print("inside if of poison")
#         trainset = poison_CIFAR10_dataset(trainset, poison_rate)
...
#                 #melicious client shouldnt say that the data is invalid
#                 # if self.previous_loss is not None and self.previous_accuracy is not None:
#                 #     if loss > self.previous_loss + self.threshold_loss or accuracy < self.previous_accuracy - self.threshold_accuracy:
#                 #         validity = 1
...
#                 print("Previous loss: "+str(self.previous_loss)+" Current loss: "+str(loss))
...
# )
# print(args.server_address,args.threshold_loss,args.threshold_accuracy,args.perturb_rate,args.poison_rate)
